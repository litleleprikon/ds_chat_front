      ...
      <div className="panel-body">
        <form onSubmit={e => {
          ...
          <div className="form-group">
            ...
            <input onChange={onUsernameChanged} type="text" className="form-control" id="register-input-username"
                   placeholder="Username"/>
          </div>
          <div className="form-group">
            <label htmlFor="register-input-password">Password</label>
            <input onChange={onPasswordChanged} type="password" className="form-control" id="register-input-password"
